...
void printEsp(int *vector, int n, int mod)
{
  int total = 0, *temp;
...
void ingV(int *vector, int n)
{
  ...
  while (flag)
  {
    ...
    switch(a) {
        case 48:
            vector[mod] = vector[mod] * 10 + 0;
            break;
        case 49:
            vector[mod] = vector[mod] * 10 + 1;
            break;
        case 50:
            vector[mod] = vector[mod] * 10 + 2;
            break;
        case 51:
            vector[mod] = vector[mod] * 10 + 3;
            break;
        case 52:
            vector[mod] = vector[mod] * 10 + 4;
            break;
        case 53:
            vector[mod] = vector[mod] * 10 + 5;
            break;
        case 54:
            vector[mod] = vector[mod] * 10 + 6;
            break;
        case 55:
            vector[mod] = vector[mod] * 10 + 7;
            break;
        case 56:
            vector[mod] = vector[mod] * 10 + 8;
            break;
        case 57:
            vector[mod] = vector[mod] * 10 + 9;
            break;
        case 8:
            vector[mod] = vector[mod] / 10;
            break;
        case 13:
            flag = 0;
            break;
  ...
  while(flag)
  {
    ...
    switch(a) {
        ...
        case 77:
            ...
            if (opcion == 2) for (int i = 0; i < n; i++) vector[i] = rand() % 2147483647;
